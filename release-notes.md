...
- Personal-account auth messaging guardrail for issue `#2568` (`MForce365.Shared/AppConfiguration.cs`, `MForce.Components/PreLoginHomePage.razor`, `MForce.Components/PreLoginHomePage.razor.cs`, `MForce365.Web/Pages/Authentication.razor`, `MForce365.Web/Pages/Authentication.razor.cs`, `MForce365.Web/Program.cs`, `MForce365.Web/wwwroot/appsettings.json`, `MForce365.Web.Tests/AuthenticationPageTests.cs`, `MForce365.Web.Tests/PreLoginRegistrationGuidanceTests.cs`, `docs/authentication.md`, `docs/development.md`, `docs/installation.md`, `docs/reseller-pack.md`, `docs/sales-data-sheet.md`, `docs/sales-slide-deck.md`, `README.md`, `RELEASE.md`):
  ...
  - Documented the March 28 issue evidence that the Microsoft sign-in page itself can reject personal accounts before Graph consent, and updated the repo docs and source-level regression checks to reflect that deployment-level constraint clearly.
  - Closes #2568.
...
- Meeting prep `Other` meeting-type formatting for issue `#2656` (`MForce365.Shared/MForceAppointment.cs`, `MForce365.Shared/MeetingTypeMetadata.cs`, `MForce365.Shared.Tests/MForceAppointmentComposeBodyTests.cs`, `MForce365.Shared.Tests/MeetingTypeMetadataTests.cs`, `docs/development.md`, `RELEASE.md`):
  ...
  - Added focused regression coverage for both HTML rendering and meeting-type extraction of the `Other` fallback.
  - Closes #2656.
